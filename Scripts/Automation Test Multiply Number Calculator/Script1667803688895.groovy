...
Windows.click(findWindowsObject('Object Repository/Button Five'))

Windows.click(findWindowsObject('Object Repository/Button Multiply'))

Windows.click(findWindowsObject('Object Repository/Button Eight'))
